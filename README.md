...
| **[exceptions](core/src/main/java/com/merkle/oss/aem/utils/exceptions)**   | <ul><li>[ErrorCode](core/src/main/java/com/merkle/oss/aem/utils/exceptions/ErrorCode.java): A marker interface for defining unique, domain-specific error codes across the AEM utility framework</li><li>[SystemException](core/src/main/java/com/merkle/oss/aem/utils/exceptions/SystemException.java): Generic system-level base `java.lang.RuntimeException` within the AEM utility framework to be extended</li></ul>                                                                                                                                                                                                                                                                                                            |
