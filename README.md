...
<p align="center">
    ...
    <a href="https://javadoc.io/doc/com.merkle.oss.aem/aem-utils.core-bundle">
        <img alt="Javadoc" src="https://javadoc.io/badge2/com.merkle.oss.aem/aem-utils.core-bundle/javadoc.svg?color=yellow"></a>
...
The **AEM Utils** is a developer toolkit engineered to modernize and streamline the development
...
| Feature                                                                    | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|:---------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **[annotations](core/src/main/java/com/merkle/oss/aem/utils/annotations)** | <ul><li>[AdaptTo](core/src/main/java/com/merkle/oss/aem/utils/annotations/injectors/AdaptTo.java): Custom Sling Models injection annotation that triggers an adaptation via `org.apache.sling.api.adapter.Adaptable`</li><li>[PageProperty](core/src/main/java/com/merkle/oss/aem/utils/annotations/injectors/PageProperty.java): Custom Sling Models injection annotation for retrieving properties from an `com.day.cq.wcm.api.Page`</li></ul>                                                                                                                                                                                                                                                                                  |
...
| **[exceptions](core/src/main/java/com/merkle/oss/aem/utils/exceptions)**   | <ul><li>[ErrorCode](core/src/main/java/com/merkle/oss/aem/utils/exceptions/ErrorCode.java): A marker interface for defining unique, domain-specific error codes across the AEM utility framework</li><li>[SystemException](core/src/main/java/com/merkle/oss/aem/utils/exceptions/SystemException.java): Generic system-level base {@code RuntimeException} exception within the AEM utility framework to be extended</li></ul>                                                                                                                                                                                                                                                                                                                      |
| **[java](core/src/main/java/com/merkle/oss/aem/utils/java)**               | <ul><li>[ClassUtil](core/src/main/java/com/merkle/oss/aem/utils/java/ClassUtil.java): Common Java reflection and class-handling tasks</li><li>[FunctionalUtil](core/src/main/java/com/merkle/oss/aem/utils/java/FunctionalUtil.java): Provides functional programming utilities to bridge Java APIs with Stream capabilities</li></ul>                                                                                                                                                                                                                                                                                                                                                                                            |
...
| **[httpclient](core/src/main/java/com/merkle/oss/aem/utils/services/httpclient)**                | <ul><li>[HttpClientService](core/src/main/java/com/merkle/oss/aem/utils/services/httpclient/HttpClientService.java): A centralized service for executing HTTP requests with specialized support for AEM security contexts</li><li>[HttpClientUtil](core/src/main/java/com/merkle/oss/aem/utils/services/httpclient/HttpClientUtil.java): Helper methods for common HTTP client operations</li></ul>                                                                                                                                                                                                         |
